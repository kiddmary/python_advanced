# 5.30:  Same decorator function as last time -- this_function() has been defined to take two
# positional arguments and two keyword arguments, printing these arguments inside this_function()).
# Inside wrapper(), we accept these arguments and pass them to myfunc() (which is this_function().
# Run this program to see that it works.  Now replace the positional arguments with *args and the
# keyword arguments with **kwargs and see that it works in the same way.
