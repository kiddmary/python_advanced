# 7.7:  obj is an instance of the Do() class; an attribute has been set in the instance,
# and the class also has its own attribute, set as a class variable.  Investigate the
