# 2.3:  Open a database file, then immediately check to see that there are tables.
...
# If you don't see any tables listed, then you have either misspelled the name of the .db file, or
# you're in the wrong directory.  First, delete the empty file that you created so you don't get
# confused.
...
# <BR>
# 
# Please note that SQL queries end in a semicolon (;) and SQLite3 commands such as .tables and
# .schema do not:
# 
# adding a semicolon to a "dot" command (e.g. .schema;) causes SQLite to ignore the command;
# 
