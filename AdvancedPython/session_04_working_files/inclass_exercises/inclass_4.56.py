...
# Use the wildcard to match everything between the first two brackets.  Note carefully what
# was printed.  (Don't forget that square brackets must be escaped with a backslash, and that
# extraction requires grouping parentheses.)
