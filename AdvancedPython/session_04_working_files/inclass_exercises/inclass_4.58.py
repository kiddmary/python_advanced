...
# In one regex match, extract the status code and bytes downloaded (last 2 integers on the line)
# from this log line.  Call .groups() the match object to reveal the extracted values.
