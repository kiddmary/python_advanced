# 3.14:  Demo exercise:  issue request with headers, parameters and data.

# Please note below the approach for setting headers, parameters and data in a request, and note
