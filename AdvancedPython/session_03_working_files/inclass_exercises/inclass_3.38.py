# 3.38:  Add a "static" HTML page with a link that calls the hello/ function, and another link that
...
# 
# After saving this page as launch.html, use your browser's File > Open File... to navigate to the
# page and display it.  You'll see the two links displayed.
# 
# Expected output:
