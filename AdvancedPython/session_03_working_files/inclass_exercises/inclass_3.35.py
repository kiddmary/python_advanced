# 3.35:  (Exploratory exercise):  view log messages at command line.

# The sample code from the hello world app contains a print() statement.  Look in the Terminal or
# Command Prompt window to see the print output displayed.
# 
