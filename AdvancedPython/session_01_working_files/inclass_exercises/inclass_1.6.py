...
#   2. Loop through the reader object line by line, printing each line. Note the type of the object
# representing each row.
#   3. Subscript the float value from each list and convert to float.
#   4. Initialize a float variable 0.0 at the top and add each float value to it inside the loop,
# producing a sum.
# 
