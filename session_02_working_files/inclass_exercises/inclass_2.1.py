# 2.1:  Open a Anaconda Prompt (Windows) or a Terminal window (Mac).  (To reach the Anaconda prompt,
# do a search for Anaconda and click Anaconad Prompt.)
...
#   * Use cd to move into a directory you see listed in the present working directory (for example
# cd Downloads)
#   * Use cd .. to move into the "parent" directory of the one you are in (this will take you back
# to the parent of Downlaods
